  ...
  return (
    <>
      <div className='card-bg border-2 rounded p-5'>
        ...
        <Cluster title={'Average Sentance Length:'} value={basicStats.averageSentenceLength + ' words'} />
        <Cluster title={'Lexical Density:'} value={Math.trunc((basicStats.lexicalDensity * 100), 10) + '%'} info={'A measure of how much information a text conveys, specifically the proportion of content words (like nouns, verbs, adjectives, and adverbs) to the total number of words.'}/>
